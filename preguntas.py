    ...
    1: {
        ...
        "preguntas": [
            ...
            },
            {
                ...
                "opciones": ["A) El Derecho es Coercible y Bilateral; la Moral es Incoercible.", "B) El Derecho es de fuero puramente interno y autónomo."],
            ...
            },
            {
                ...
                "opciones": ["A) Pautas de decoro y cortesía dictadas por la sociedad civil.", "B) Mandatos imperativos escritos de forma parlamentaria."],
            ...
            },
            {
                ...
                "opciones": ["A) Usos sociales acarrean rechazo; las jurídicas castigo estatal.", "B) Los usos confieren acciones legales directas ante tribunales."],
    ...
    2: {
        ...
        "preguntas": [
            ...
            },
            {
                ...
                "opciones": ["A) Imperativas ordenan u prohíben; Permisivas conceden opción.", "B) Imperativas otorgan derecho opcional; Permisivas imponen cárcel."],
    ...
    3: {
        ...
        "preguntas": [
            ...
            },
            {
                ...
                "opciones": ["A) Iusnaturalista (justicia) e Iuspositivista (legalidad formal).", "B) Sociológica (fuerza real) y Contractualista privada."],
    ...
    5: {
        ...
        "preguntas": [
            ...
            },
            {
                ...
                "correcta": "A) Una declaración de la voluntad soberana que, manifestada en la forma prescrita por la Constitución, manda, prohíbe o permite.",
                "explicacion": "Emana de la potestad soberana, regulando de forma abstracta."
            },
            {
                "sub": "5.3 d)", "preg": "La ley: efectos en el espacio.",
                "opciones": ["A) Territorialidad (Art. 14 CC) y Extraterritorialidad.", "B) Inmunidad general del extranjero frente a normas locales."],
                "correcta": "A) Territorialidad (Art. 14 CC) y Extraterritorialidad.",
                "explicacion": "Vincula a nacionales y extranjeros dentro de las fronteras."
            },
            {
                "sub": "5.3 e)", "preg": "La ley: efectos en el tiempo.",
                "opciones": ["A) Irretroactividad (Art. 9 CC) and Favorabilidad Penal.", "B) Retroactividad obligatoria general de todas las leyes."],
