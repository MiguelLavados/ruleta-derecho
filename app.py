...
with col2:
    ...
    if st.session_state.cedula_activa:
        ...
        st.markdown(f"<div class='box-minutero'><b style='color: #1A73E8;'>⏱️ MINUTERO (CONTEXTO):</b><br>Pregunta N° {st.session_state.cedula_activa}</div>", unsafe_allow_html=True)
