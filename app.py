...
# BASE DE DATOS RECTIFICADA (CÉDULAS 1 A 5 SIN PISARSE EN MEMORIA)
DATOS_EXAMEN = {
    1: {
        "titulo": TITULOS[1],
        "preguntas": [
    ...
    3: {
        ...
        "preguntas": [
            ...
            {"sub": "3.1 c)", "preg": "¿Cómo opera la derogación Tácita de una ley?", "opts": ["A) Cuando la nueva ley contiene disposiciones incompatibles con la ley anterior.", "B) Cuando el nuevo texto declara de forma explícitamente qué artículos caducan."], "ok": "A", "fund": "Se fundamenta en la incompatibilidad lógica infranqueable de preceptos."},
    ...
    4: {
        "titulo": TITULOS[4],
        "preguntas": [
            {"sub": "4.1", "preg": "En relación al principio de inexcusabilidad (Art. 76 CPR), ¿qué obligación impone a los tribunales?", "opts": ["A) Autoriza a rechazar causas ante vacíos de la legislación.", "B) Obliga a los jueces a resolver conflictos de su competencia, aun sin ley expresa aplicable."], "ok": "B", "fund": "El juez no puede negarse a administrar justicia; ante lagunas debe integrar el sistema."},
            ...
            {"sub": "4.3", "preg": "¿Cómo procede la solución por vía de integración?", "opts": ["A) El magistrado llena el vacío recurriendo a analogía, principios generales y equidad natural.", "B) Suspende el proceso de forma obligatoria."], "ok": "A", "fund": "Construye la regla de fallo desde las bases del propio ordenamiento."},
    ...
    5: {
        ...
        "preguntas": [
            ...
            {"sub": "5.3 a/b/c", "preg": "¿Cómo define la ley el Código Civil (Art. 1)?", "opts": ["A) Declaración de voluntad soberana que manda, prohíbe o permite.", "B) Mandato coyuntural particular expedido por la magistratura ordinaria."], "ok": "A", "fund": "Nota característica redactada por Andrés Bello de carácter general y abstracto."},
            {"sub": "5.3 d)", "preg": "Respecto al ámbito espacial, ¿qué estatuye el principio de territorialidad (Art. 14 CC)?", "opts": ["A) La ley es obligatoria para todos los habitantes de la República, incluso extranjeros, dentro de las fronteras.", "B) Inmunidad jurisdiccional absoluta para los turistas."], "ok": "A", "fund": "Un extranjero que transita por el territorio debe cumplir estrictamente la ley chilena."},
            {"sub": "5.3 e)", "preg": "En cuanto al ámbito temporal, ¿cuál es el alcance del Principio de Irretroactividad (Art. 9 CC)?", "opts": ["A) Faculta al Estado a castigar retroactivamente conductas lícitas.", "B) La ley solo dispone para el futuro y jamás rige hacia atrás, salvo favor penal."], "ok": "B", "fund": "Resguarda la certeza jurídica impidiendo alterar situaciones consolidadas pretéritas."}
        ]
    }
}
