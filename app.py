...
# Estilos CSS Limpios y la animación de desvanecimiento de 35 segundos
st.markdown(
    """
    <style>
    ...
    /* Estilo del Tambor Digital del Reloj */
    .reloj-display {
...
# Base de datos oficial basada en el Cedulario USS 2026
CEDULARIO_COMPLETO = {
    1: {
...
with col_izq:
    ...
    # Renderizado de la estructura circular del reloj mediante un contenedor estilizado seguro
    if st.session_state.cedula_activa:
        texto_reloj = f"{st.session_state.cedula_activa:02d}"
        sub_texto = "CÉDULA ACTIVA"
    else:
        texto_reloj = "--"
        sub_texto = "RELOJ DETENIDO"
        
    st.markdown(
        f"""
        <div class='reloj-display'>
            <span style='font-size: 14px; color: #A0AAB2; font-weight: bold; letter-spacing: 2px;'>{sub_texto}</span>
            <span style='font-size: 64px; font-weight: bold; color: #FFFFFF; font-family: monospace; margin: 10px 0;'>{texto_reloj}</span>
