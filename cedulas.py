CEDULARIO_COMPLETO = {
    ...
    5: {
        ...
        'items': [
            ...
            {'sub': '5.2', 'pregunta': 'Mencione la clasificación general de las Fuentes Formales.', 'ok': 'Se clasifican principalmente en Ley (potestad legislativa), Costumbre, Jurisprudencia (fallos) y la Doctrina (estudios de juristas).'},
    ...
    6: {
        ...
        'items': [
            ...
            {'sub': '6.2', 'pregunta': 'Analice el valor legal de la costumbre en las distintas ramas del Derecho chileno.', 'ok': 'En Civil: solo según la ley (Art 2 CC). En Comercial: en silencio de ley (Art 4 CCom). En Penal: rechazada por legalidad estricta.'}
        ]
    },
    7: {
    ...
    9: {
        ...
        'items': [
            ...
            {'sub': '9.3', 'pregunta': 'Explique la responsabilidad civil contractual y extracontractual de las personas jurídicas por actos de dependientes.', 'ok': 'Responden contractualmente por incumplimientos y extracontractualmente por delitos civiles de dependientes (Art 2320 CC).'},
